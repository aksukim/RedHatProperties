...
const storage = multer.diskStorage({
  ...
  filename: (_req, file, cb) => {
    // Preserve original filename; prevent path traversal
...
// GET /api/listings — return active + sold arrays
...
// POST /api/listings — save full listings object (admin only)
...
// POST /api/listings/image — upload image file (admin only)
